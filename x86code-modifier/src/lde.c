...
typedef unsigned short int word, WORD, *PWORD;
typedef unsigned int dword, DWORD, *PDWORD;
typedef int BOOL;

BOOL GetInstructionSize(PBYTE pOpCode, PDWORD pdwInstructionSize)
{
    PBYTE    opcode = pOpCode;
    DWORD    i = 0;
    ...
    BYTE    disasm_mem [8] = {0};   // mem addr value
    BYTE    disasm_data [8] = {0};  // data value
    ...
    if (!pdwInstructionSize) return false;
...
RETRY:
    ...
    switch(disasm_opcode)
    {
        ...
        case 0xCD:
            ...
            disasm_datasize += (*opcode == 0x20 ? 1 + 4 : 1);
            break;
        ...
        case 0x64: case 0x65:
                ...
                if (disasm_flag & C_SEG) return false;
        ...
        case 0xF0:
                ...
                if (disasm_flag & C_LOCK) return false;
        ...
        case 0xF2: case 0xF3:
                ...
                if (disasm_flag & C_REP) return false;
        ...
        case 0x66:
                if (disasm_flag & C_66) return false;
        ...
        case 0x67:
                ...
                if (disasm_flag & C_67) return false;
        ...
        case 0xEA:
            ...
            disasm_datasize += (2 + disasm_defdata);
            break;
    ...
    disasm_len = (DWORD) (opcode - pOpCode);
    *pdwInstructionSize = disasm_len;
